...
hw-h9-numeric-repair:
	$(PYTHON) scripts/sim/run_hw_h9_numeric_repair.py

hw-h9-q2-length1:
	$(PYTHON) scripts/sim/run_hw_h9_q2_length1.py
...
hw-h9-thesis-acceptance:
	PYTHON=$(PYTHON) bash scripts/sim/run_hw_h9_thesis_acceptance.sh
