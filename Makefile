...
ml-m2-unit-test:
	$(PYTHON) scripts/ml/run_ml_m2_unit_tests.py

ml-m2-data-test:
	$(PYTHON) scripts/ml/run_ml_m2_data_tests.py

ml-m2-tokenizer-test:
	$(PYTHON) scripts/ml/run_ml_m2_data_tests.py

ml-m2-smoke-test:
	$(PYTHON) scripts/ml/run_ml_m2_smoke_test.py

ml-m2-export-test:
	$(PYTHON) scripts/ml/run_ml_m2_export_trace_tests.py
...
ml-m2-gpu-check:
	$(PYTHON) scripts/ml/run_ml_m2_gpu_check.py
...
ml-m2-formal-train:
	$(PYTHON) scripts/ml/run_ml_m2_formal_train.py

ml-m2-formal-eval:
	$(PYTHON) scripts/ml/run_ml_m2_formal_eval.py
