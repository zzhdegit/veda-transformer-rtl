...
set rtl_files [list \
    ...
    [file join $root "rtl/projection/qkv_projection_engine.sv"] \
    [file join $root "rtl/attention/projected_multi_head_attention.sv"] \
]
...
check_one projected_multi_head_attention "N_HEAD=1,D_HEAD=8,PE_NUM=8,MAX_SEQ_LEN=8" [file join $report_dir "dc_check_projected_mha_h1_d8.rpt"]
check_one projected_multi_head_attention "N_HEAD=2,D_HEAD=8,PE_NUM=8,MAX_SEQ_LEN=8" [file join $report_dir "dc_check_projected_mha_h2_d8.rpt"]
check_one projected_multi_head_attention "N_HEAD=4,D_HEAD=8,PE_NUM=8,MAX_SEQ_LEN=8" [file join $report_dir "dc_check_projected_mha_h4_d8.rpt"]
check_one projected_multi_head_attention "N_HEAD=2,D_HEAD=16,PE_NUM=8,MAX_SEQ_LEN=8" [file join $report_dir "dc_check_projected_mha_h2_d16.rpt"]
