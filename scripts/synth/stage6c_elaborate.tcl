...
check_one qkv_staging_buffer "N_HEAD=1,D_HEAD=8" [file join $report_dir "dc_check_qkv_staging_h1_d8.rpt"]
check_one qkv_projection_engine "N_HEAD=1,D_HEAD=8,PE_NUM=8" [file join $report_dir "dc_check_qkv_projection_h1_d8.rpt"]
check_one qkv_projection_engine "N_HEAD=2,D_HEAD=8,PE_NUM=8" [file join $report_dir "dc_check_qkv_projection_h2_d8.rpt"]
check_one qkv_projection_engine "N_HEAD=4,D_HEAD=8,PE_NUM=8" [file join $report_dir "dc_check_qkv_projection_h4_d8.rpt"]
check_one qkv_projection_engine "N_HEAD=2,D_HEAD=16,PE_NUM=8" [file join $report_dir "dc_check_qkv_projection_h2_d16.rpt"]
